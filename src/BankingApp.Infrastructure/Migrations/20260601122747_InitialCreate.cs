        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NetSavings = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BudgetSet = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BudgetUsedPercent = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MonthlyReports_BankAccounts_BankAccountId",
                        column: x => x.BankAccountId,
                        principalTable: "BankAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecurringPayments_BankAccounts_BankAccountId",
                        column: x => x.BankAccountId,
                        principalTable: "BankAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonthlyReports_BankAccountId",
                table: "MonthlyReports",
                column: "BankAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_RecurringPayments_BankAccountId",
